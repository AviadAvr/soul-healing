...
export default function Home(props) {
  ...
  // On touch/mobile devices the email opens the mail app (mailto); on desktop
  // it copies to the clipboard instead. Default to desktop for SSR, then refine
  ...
  return (
    <>
              ...
              <div className="contact__details">
                ...
                <ul className="contact__list">
                  <li>
                    ...
                    <span className="contact__tel-row">
      ...
      {/* "Email copied" toast — announced politely for screen readers. */}
      <div
        className={`toast${emailCopied ? " is-visible" : ""}`}
        role="status"
        aria-live="polite"
      >
